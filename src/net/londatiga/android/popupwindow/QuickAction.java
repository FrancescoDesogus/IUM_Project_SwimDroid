package net.londatiga.android.popupwindow;
...
//		mArrowUp 	= (ImageView) mRootView.findViewById(R.id.arrow_up);
	...
	public void show (View anchor) {
		...
		if(onTop)
			mTrack.setBackgroundResource(R.drawable.quickaction);
		else mTrack.setBackgroundResource(R.drawable.quickaction_down);
