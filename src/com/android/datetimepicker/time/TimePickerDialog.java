...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    //Flag per cambiare le stringhe nel caso sia un tempo per le ripetizioni
    private boolean isSwimTime;
    ...
    public TimePickerDialog(Context context, int theme, OnTimeSetListener callback,
            int hourOfDay, int minute, boolean is24HourMode, boolean isSwimTime) {
        // Empty constructor required for dialog fragment.
    }
    ...
    public static TimePickerDialog newInstance(OnTimeSetListener callback,
        ...
        ret.initialize(callback, hourOfDay, minute, is24HourMode, isSwimTime);
        return ret;
    }

    public void initialize(OnTimeSetListener callback,
            int hourOfDay, int minute, boolean is24HourMode, boolean isSwimTimePar) {
        mCallback = callback;
        ...
        mInKbMode = false;
        mThemeDark = false;
        this.isSwimTime = isSwimTimePar; //salvo il flag
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(KEY_HOUR_OF_DAY)
            ...
            isSwimTime = savedInstanceState.getBoolean("isSwimTime"); //ricarico il valore del flag salvato
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mIs24HourMode) {
            ...
            //se il flag è true
            if(this.isSwimTime){
            	Log.w("timePicker", "isSwimTime=True");
            	separatorView.setText("'"); //cambio il primo separatore
            	view.findViewById(R.id.separatorSwim).setVisibility(View.VISIBLE); //e setto visibile il secondo
            }
            else 
            	Log.w("timePicker", "isSwimTime=False");
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (mTimePicker != null) {
            ...
            outState.putBoolean("isSwimTime", isSwimTime); //salvo il valore del flag
            if (mInKbMode) {
